...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (mode == Mode.LEXER) {
            ...
            System.out.println("AST builder not yet implemented");
        } else if (mode == Mode.SEMANTICANALYSIS) {
            System.out.println("Semantic analyser not yet implemented");
        }
        else if (mode == Mode.GEN) {
            System.out.println("Code generator not yet implemented");
        } else {
